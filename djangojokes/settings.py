...
SECRET_KEY = "django-insecure-t$mwc_&^v%4v(qnff13cp+(b^glgdn6_yq_uk3gf!zc7y0p_n!"
...
INSTALLED_APPS = [
    ...
    # third party apps installed by pip install django-allauth
    'allauth',
    'allauth.account',
...
# set SITE_ID for django-allauth app 
SITE_ID = 1
...
""" Replace with postgreSQL database below
DATABASES = {
    "default": {
...
# Add database setting to PostgreSQL
DATABASES = {
    'default': {
...
# EMAIL for django-allauth in production using SendGrid
# see local_settings.py for development setting for SendGrid 
...
# set AUTHENTICATION_BACKENDS for django-allauth app
...
# custom registration form to override the default from django-allauth
...
# Add STACTICFILES_DIR list of project static folder
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
